...
from backend.src.notify.api.dependencies.auth import UserService
...
def users_update():
    service = loop.run_until_complete(
        UserService.create_service(
            ...
            mysql_db_connection=mongo_db_connection,
...
if __name__ == "__main__":
    ...
    db_my_sql_conn = loop.run_until_complete(
        get_my_sql_db_connection(
