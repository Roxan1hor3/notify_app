...
from backend.src.notify.adapters.models.user import User
from backend.src.notify.adapters.services.user_service import UserService
from backend.src.notify.api.dependencies.auth import authenticate_user
from backend.src.notify.api.dependencies.services import get_user_service
