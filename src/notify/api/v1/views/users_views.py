...
from src.notify.api.v1.schemas.users_schemas import QueryUserNotifySchema, validate_groups
...
async def get_user_list(
    ...
    user_notify_file = await user_service.get_user_notify_file(params=params, group_ids=group_ids)
    return FileResponse(
        user_notify_file,
